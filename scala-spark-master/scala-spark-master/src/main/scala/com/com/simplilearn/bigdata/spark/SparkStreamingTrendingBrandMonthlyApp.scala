...
object SparkStreamingTrendingBrandMonthlyApp {
  ...
  def main(args: Array[String]) {
    ...
    val brandOrderCount = allProducts.map((record) => (record.toString.split(",")(2), record.toString.split(",")(8).toInt)).reduceByKey((i1, i2) => i1 + i2)
