...
object SparkStreamingTrendingCategoryMonthlyApp {
  ...
  def main(args: Array[String]) {
    ...
    val categoryOrderCount = allProducts.map((record) => (record.toString.split(",")(3), record.toString.split(",")(8).toInt)).reduceByKey((i1, i2) => i1 + i2)
